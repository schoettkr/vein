...
-- local bind = require('keybindings.bind')
...
-- local keymap = {
--   -- Nvim Tree
--     ["|<Leader>ft"]      = map_cr('NvimTreeFindFile'):with_noremap():with_silent(),
--     ["v|<Leader>ft"]      = map_cr('NvimTreeFindFile'):with_noremap():with_silent(),
--     ["n|<Leader>ad"]      = map_cr('NvimTreeFindFile'):with_noremap():with_silent(),
...
--     ["n|<Leader>pp"]     = map_cu('Telescope git_files'):with_noremap():with_silent(),
--     ["n|<Leader>p."]     = map_cu('Telescope find_files'):with_noremap():with_silent(),
...
--     ["n|<Leader>rr"]     = map_cu('Telescope registers'):with_noremap():with_silent(),

--   -- Vanilla VIM
--     ["n|<Leader>ws"]     = map_cu('split'):with_noremap():with_silent(),
--     ["n|<Leader>wv"]     = map_cu('vsplit'):with_noremap():with_silent(),
--     ["n|<Leader>wd"]     = map_cu('close'):with_noremap():with_silent(),
--     ["n|<Leader>qq"]     = map_cu('quitall'):with_noremap():with_silent(),
--     ["n|<Leader>bd"]     = map_cu('bdelete'):with_noremap():with_silent(),
...
-- vim.api.nvim_set_keymap('n', '<Leader>fk', 'NvimTreeFindFile', { noremap = false, silent = true })
